...
h_text_distribution = text( ...
    'Parent', h_axes, ...
    'Tag', 'H_TEXT_BRAPH2', ...
    'String', ['{\color{black}' BRAPH2.DISTRIBUTION '}'], ...
    'FontSize', BRAPH2.FONTSIZE * 1.8, ...
    'Position', [size(icon, 1)/2 size(icon, 2)+BRAPH2.FONTSIZE*15], ...
    'HorizontalAlignment', 'center', ...
    'VerticalAlignment', 'top' ...
    ); %#ok<NASGU>
...
h_text_credits = text( ...
    ...
    'Position', [size(icon, 1)/2 size(icon, 2)+BRAPH2.FONTSIZE*30], ...
    'HorizontalAlignment', 'center', ...
    'VerticalAlignment', 'top' ...
    ); %#ok<NASGU>
